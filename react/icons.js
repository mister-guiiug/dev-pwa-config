...
/**
 * L'arc qui tourne : « occupé ». Le rôle `busy` de `BottomNav` pendant qu'un
 * morceau de route arrive — même tracé que `LoaderCircle` de lucide, pour que
 * les apps avec et sans lucide voient la même chose. La rotation est l'affaire
 * de `components.css` (`dwc-spin`), pas du dessin.
 * @param {{ size?: number }} [props]
 */
