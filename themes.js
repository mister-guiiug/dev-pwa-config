...
export const FAMILY_THEMES = [
...

  {
    ...
    fontDisplay: null,
    radius: '0.75rem',
    // Relevé dans `src/shared/styles/index.css`, qui exprime tout en OKLCH :
    // les valeurs ci-dessous en sont la conversion sRGB exacte, pas une
    // approximation à vue. `info` n'existe pas dans l'app — c'est le repli de
    // `components.css` qui est reporté, pour ne pas inventer un rôle.
    light: {
      bg: '#fefcf6',
      surface: '#fefcf6',
      surface2: '#f5f2e9',
