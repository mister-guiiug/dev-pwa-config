...
globalThis.SHOWROOM_ADOPTION = {
  generatedAt: '2026-08-30T20:43:37.047Z',
  measured: 17,
  total: 17,
  apps: {
    'miss-badminton': {
      ...
      measuredAt: '2026-08-30T20:43:37.047Z',
    },
    'miss-carbook': {
      symbols: [
        'ChannelStatus',
  ...
  bySymbol: {
    ...
    RegisterSW: ['mister-doc', 'mister-footcoach', 'mister-qowa'],
    Rgb: ['mister-doc'],
  ...
  byDuplicate: {
    ...
    backup: ['miss-contraction', 'miss-uwh', 'mister-cim10', 'mister-molkky'],
    BottomNav: [
      'miss-contraction',
      'mister-doc',
      'mister-footcoach',
    ...
    format: ['miss-genius', 'miss-lookhouse', 'miss-supaboss', 'miss-uwh'],
    geo: ['miss-lookhouse'],
    ThemeToggle: ['miss-lookhouse', 'miss-ticket-pwa', 'mister-doc'],
    Toast: ['miss-uwh', 'mister-quota'],
    webVitals: ['mister-cim10'],
    Badge: ['mister-doc'],
    ConfirmDialog: ['mister-quota'],
    ErrorBoundary: ['mister-quota'],
  },
};
