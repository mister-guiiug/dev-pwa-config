...
globalThis.SHOWROOM_ADOPTION = {
  generatedAt: '2026-09-05T13:42:09.126Z',
  measured: 19,
  total: 19,
  apps: {
    'miss-badminton': {
    ...
    'miss-supatool': {
      ...
      kept: [],
      measuredAt: '2026-09-05T13:42:09.126Z',
    },
    'miss-ticket-pwa': {
      symbols: [
        'ALPHABETS',
  ...
  bySymbol: {
    ...
    pagesUrl: ['miss-dice'],
    AppHeader: ['miss-genius', 'miss-supatool', 'mister-miss-koh'],
    Button: [
      'miss-genius',
      'miss-supatool',
      'miss-uwh',
    ...
    createVersionedStore: ['miss-genius', 'miss-uwh', 'mister-miss-koh'],
    formatNumber: [
      'miss-genius',
      'miss-lookhouse',
      'miss-supatool',
    ...
    CardHeader: ['miss-supatool', 'mister-footcoach', 'mister-miss-koh'],
    PageContainer: ['miss-supatool', 'mister-miss-koh'],
    SegmentedControl: ['miss-supatool'],
    Stat: ['miss-supatool'],
    formatBytes: ['miss-supatool'],
    ...
    usePullToRefresh: ['mister-molkky'],
